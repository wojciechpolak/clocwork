...
def render(
    ...
    # With no stamp the sentence gets shorter rather than keeping a hole.
    if report.generated_at:
        lines.append(
            f"Generated: {report.generated_at} "
            f"by clocwork {report.clocwork_version}"
        )
    else:
        lines.append(f"Generated by clocwork {report.clocwork_version}")
